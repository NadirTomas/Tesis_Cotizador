...
from app.api.v1.routes_client_errors import limiter as client_errors_limiter
...
_LIMITERS = (main_limiter, auth_limiter, pieces_limiter, companies_limiter, client_errors_limiter)
